...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
     ...
     I wasn't sure if the script ran successfully and I couldn't re-run it as it would mess up the system. 
     Then I thought of checking the localhost logs. From there, I was able to see that the script was still running and I just need to monitor it from the logs instead.
